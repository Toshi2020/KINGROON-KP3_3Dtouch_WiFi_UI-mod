...
//	Configurations\config\examples\Kingroon\KP3\Configuration_adv.hを改修

// 印刷中断後の処理を変更
#undef EVENT_GCODE_SD_ABORT
#define	EVENT_GCODE_SD_ABORT "G28X\nM18"	// X軸を原点に戻しモーターをオフ

// フィラメントのUnload長さのデフォルト値を変更
#undef	FILAMENT_CHANGE_UNLOAD_LENGTH
#define	FILAMENT_CHANGE_UNLOAD_LENGTH	330

// フィラメントのLoad/Unloadメニューを追加
#define	FILAMENT_LOAD_UNLOAD_GCODES

//---------- 3D Touch組み込みのための変更 ----------
#ifdef BLTOUCH

#define	PROBE_OFFSET_WIZARD	//プローブZオフセット調整ウイザードメニューを追加
...
// ベッドレベリングを実行してEEPにストアする
#define	MAIN_MENU_ITEM_1_DESC "Bed Leveling & Store Settings"
#define	MAIN_MENU_ITEM_1_GCODE "G28\nG29\nM500"
